...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { amount: @batch.amount, desc: @batch.desc, farmer_id: @batch.farmer_id, name: @batch.name, price: @batch.price } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { amount: @batch.amount, desc: @batch.desc, farmer_id: @batch.farmer_id, name: @batch.name, price: @batch.price } }
